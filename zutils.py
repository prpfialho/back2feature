...
def get_ms(dsetpart, tokenizer, cased=True, maxlen=128, pathprefx='/afs/l2f/home/pfialho/PycharmProjects/phd/msr'):
    dev_dict = {}
    tr_dict = {
        "input_ids": [],
        "token_type_ids": [],
    ...
    if dsetpart == 'train':
        ...
        dev_ids = []
        with open('/afs/l2f/home/pfialho/backupffs/phd/data/glue-msrp-dev_ids.tsv') as f:
            for line in f:
                lineitems = line.strip().split('\t')
...
def lex_features(dsetpart, dvec_lex=None, scalr_lex=None,
                 cprefx='/afs/l2f/home/pfialho/backupffs/phd/cache/assin2/lex-pt_XyID_assin2-'):
...
def bert_in_assin12(dsetpart, tokenizer, cased=True, maxlen=128, norm_sim=False,
                    pathprefx='/afs/l2f/home/pfialho/backupffs/phd/data/assin/assin2-'):
